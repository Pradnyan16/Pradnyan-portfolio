           ...
           >
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-white/10 mb-12">
               <div className="flex flex-col items-center justify-center p-8 border-b md:border-b-0 md:border-r border-white/10 hover:bg-white/5 transition-colors cursor-crosshair text-center">
                 <span className="text-xl md:text-2xl font-bold uppercase text-white mb-2">30 Mins</span>
                 <span className="font-mono text-xs uppercase tracking-widest text-zinc-500">Duration</span>
               </div>
               <div className="flex flex-col items-center justify-center p-8 border-b md:border-b-0 md:border-r border-white/10 hover:bg-white/5 transition-colors cursor-crosshair text-center">
                 <span className="text-xl md:text-2xl font-bold uppercase text-white mb-2">Video Call</span>
                 <span className="font-mono text-xs uppercase tracking-widest text-zinc-500">Format</span>
               </div>
               <div className="flex flex-col items-center justify-center p-8 hover:bg-white/5 transition-colors cursor-crosshair text-center">
                 <span className="text-xl md:text-2xl font-bold uppercase text-white mb-2">Flexible</span>
                 <span className="font-mono text-xs uppercase tracking-widest text-zinc-500">Timing</span>
               </div>
             </div>
